...
import com.pm.cameraui.api.ApiRetrofit;
import com.pm.cameraui.api.ApiServer;
...
public class BasePresenter<V extends BaseView> {
    ...
    public void addDisposable(Observable<?> flowable, BaseObserver observer) {
        ...
        compositeDisposable.add(flowable.subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribeWith(observer));
    }
